...
public class ClubeService {
    ...
    public Clube updateClube(Long id, ClubeDto clubeDto) {
        ...
        validaDados(clubeDto);
        verificaDataPartidaInvalida(id, clubeDto.getDataCriacao());
    ...
    private void validaDados(ClubeDto clubeDto) {
        if (clubeDto.getNome() == null || clubeDto.getNome().isEmpty()) {
    ...
    private void verificaDataPartidaInvalida(Long id, LocalDate dataHora) {
